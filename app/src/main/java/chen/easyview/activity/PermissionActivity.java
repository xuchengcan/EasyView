...
//            startActivity(intent);
    ...
    private Spanned getString(String permission) {
        ...
        switch (permission) {
            ...
            case Manifest.permission.WRITE_EXTERNAL_STORAGE:
                return Html.fromHtml("我们需要获取<font color='#0378d8'>SD卡</font>权限，以便为您提供相应服务。否则您将无法正常更新或使用求职宝");
            case Manifest.permission.READ_PHONE_STATE:
                return Html.fromHtml("我们需要获取<font color='#0378d8'>读取设备信息</font>权限，以便为您提供相应服务。否则您将无法正常更新或使用求职宝");
            case Manifest.permission.READ_CONTACTS:
    ...
    private Spanned getString2(String permission) {
        ...
        switch (permission) {
            case Manifest.permission.ACCESS_COARSE_LOCATION:
            case Manifest.permission.ACCESS_FINE_LOCATION:
                return Html.fromHtml("由于无法获取<font color='#0378d8'>位置信息</font>权限，请手动开启该该权限，以便获取更好的体验<br><br>设置路径：系统设置->求职宝->权限");
            case Manifest.permission.CAMERA:
                return Html.fromHtml("由于无法获取<font color='#0378d8'>相机</font>权限，请手动开启该该权限，以便获取更好的体验<br><br>设置路径：系统设置->求职宝->权限");
            case Manifest.permission.WRITE_EXTERNAL_STORAGE:
                return Html.fromHtml("由于无法获取<font color='#0378d8'>SD卡</font>权限，请手动开启该该权限，以便获取更好的体验<br><br>设置路径：系统设置->求职宝->权限");
            case Manifest.permission.READ_PHONE_STATE:
                return Html.fromHtml("由于无法获取<font color='#0378d8'>读取设备信息</font>权限，请手动开启该该权限，以便获取更好的体验<br><br>设置路径：系统设置->求职宝->权限");
            case Manifest.permission.READ_CONTACTS:
                return Html.fromHtml("由于无法获取<font color='#0378d8'>读取联系人</font>权限，请手动开启该该权限，以便获取更好的体验<br><br>设置路径：系统设置->求职宝->权限");
            case Manifest.permission.RECORD_AUDIO:
                return Html.fromHtml("由于无法获取<font color='#0378d8'>麦克风</font>权限，请手动开启该该权限，以便获取更好的体验<br><br>设置路径：系统设置->求职宝->权限");
            default:
                return Html.fromHtml("权限缺少将对体验造成较大影响");
        }
    }
