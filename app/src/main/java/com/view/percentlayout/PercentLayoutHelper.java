...
package com.view.percentlayout;
...
public class PercentLayoutHelper {
    ...
    private void getScreenSize() {
        ...
        if (BaseConfig.isDebug) {
            ...
            if (Build.BRAND.equalsIgnoreCase("xiaomi") || Build.BRAND.equalsIgnoreCase("HONOR")) {
                mWidthScreen = 720;
                mHeightScreen = 1280;
            }
            ...
            if (Build.BRAND.equals("Xiaomi") && Build.VERSION.SDK_INT > 24) { // Mix 2
                mWidthScreen = 1080;
                mHeightScreen = 2030;
            }
...
//            }
    ...
    private static PercentLayoutInfo.PercentVal getPercentVal(String percentStr, boolean isOnWidth) {
        ...
        boolean is_ = false;
        if (percentStr.charAt(0) == '-') {
            percentStr = percentStr.substring(1, percentStr.length());
            is_ = true;
        }
        ...
        float percent;
        if (is_) {
            percent = Float.parseFloat(floatVal) / 100f * -1;
        } else {
