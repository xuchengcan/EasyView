...
public class SharedPreferencesUtils {
    ...
    public static boolean putAll(String name, String key, List<?> list) {
        if (TextUtils.isEmpty(key) || TextUtils.isEmpty(list)) {
     ...
     * @return
     */
    public static long getLong(String name, String key, long def) {
     ...
     * @return
     */
    public static float getFloat(String name, String key, float def) {
        return getSharedPreferences(name).getFloat(key, def);
    }
     ...
     * @return
     */
    public static int getInt(String name, String key, int def) {
